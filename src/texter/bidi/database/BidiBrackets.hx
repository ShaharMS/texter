...
/**
 * Collection of all parenthesis and brackets
 */
class BidiBrackets {
	public static var brackets(default, null):Map<String, Array<String>> = [
		"\u0028" => ["\u0029", "o"], // LEFT PARENTHESIS
		"\u0029" => ["\u0028", "c"], // RIGHT PARENTHESIS
	...
	public static var mirrored(default, null):Map<String, String> = [
		'\u0028' => '\u0029', // LEFT PARENTHESIS
		'\u0029' => '\u0028', // RIGHT PARENTHESIS
		'\u003C' => '\u003E', // LESS-THAN SIGN
		'\u003E' => '\u003C', // GREATER-THAN SIGN
