...
class MarkdownBlocks
{
	public static var blockSyntaxMap(default, null):Map<String, String->Array<{color:Int, start:Int, end:Int}>> = [
		"json" => parseJSON, "haxe" => parseHaxe, "hx" => parseHaxe, "c" => parseC, "cpp" => parseCPP, "csharp" => parseCSharp, "cs" => parseCSharp,
		"java" => parseJava, "js" => parseJS, "php" => parsePHP, "python" => parsePython, "ruby" => parseRuby, "sql" => parseSQL, "xml" => parseXML,
		"yaml" => parseYAML, "html" => parseHTML, "css" => parseCSS, "ocaml" => parseOCaml, "ts" => parseTS, "go" => parseGo, "kotlin" => parseKotlin,
		"rust" => parseRust, "scala" => parseScala, "swift" => parseSwift, "typescript" => parseTS, "lua" => parseLua, "haskell" => parseHaskell,
		"erlang" => parseErlang, "elixir" => parseElixir, "elm" => parseElm, "clojure" => parseClojure, "crystal" => parseCrystal, "dart" => parseDart,
		"golang" => parseGo, "assembly" => parseAssembly, "vb" => parseVB, "basic" => parseBasic, "vhdl" => parseVHDL, "wasm" => parseWASM,
		"solidity" => parseSolidity, "cmake" => parseCMake, "default" => parseDefault
	];
	...
	public static dynamic function parseHaxe(text:String):Array<{color:Int, start:Int, end:Int}>
	{
		...
		for (i in indexOfBlue)
			interp.push({color: 0x4169E1, start: i.startIndex + 1, end: i.endIndex});
		for (i in indexOfClassName)
			interp.push({color: 0x42B473, start: i.startIndex + 1, end: i.endIndex});
		...
		for (i in indexOfConditionals)
			interp.push({color: 0x888888, start: i.startIndex, end: i.endIndex});
		return interp;
	}
	...
	public static dynamic function parseCSharp(text:String):Array<{color:Int, start:Int, end:Int}>
	{
		...
		for (i in indexOfFunctionName)
			interp.push({color: 0xFF8700, start: i.startIndex, end: i.endIndex - 1});
		for (i in indexOfPurple)
			interp.push({color: 0xDC52BF, start: i.startIndex + 1, end: i.endIndex});
		for (i in indexOfString)
			interp.push({color: 0xFF7F50, start: i.startIndex, end: i.endIndex});
		for (i in indexOfNumbers)
			interp.push({color: 0x62D493, start: i.startIndex, end: i.endIndex});
	...
	public static dynamic function parseC(text:String):Array<{color:Int, start:Int, end:Int}>
	{
		...
		for (i in indexOfBlue)
			interp.push({color: 0x4169E1, start: i.startIndex + 1, end: i.endIndex});
		for (i in indexOfFunctionName)
			interp.push({color: 0xFF8700, start: i.startIndex + 1, end: i.endIndex - 1});
		for (i in indexOfPurple)
			interp.push({color: 0xDC52BF, start: i.startIndex + 1, end: i.endIndex});
		for (i in indexOfString)
			interp.push({color: 0xFF7F50, start: i.startIndex, end: i.endIndex});
		...
		for (i in indexOfComments)
			interp.push({color: 0x556B2F, start: i.startIndex, end: i.endIndex});
		for (i in indexOfPink)
			interp.push({color: 0xFF00FF, start: i.startIndex, end: i.endIndex});
		return interp;
	}

	public static dynamic function parseR(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseCPP(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseFlash(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseXML(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseXAML(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseJava(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseKotlin(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseGo(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseHTML(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseCSS(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseSCSS(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseVue(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseJS(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseTS(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseLua(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseDart(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parsePython(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parsePHP(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseRuby(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseSQL(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseRust(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parsePerl(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseOCaml(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseYAML(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseHaskell(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseCrystal(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseClojure(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseScala(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseLisp(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseSwift(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseElixir(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseErlang(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseElm(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseAssembly(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseVB(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseBasic(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseVHDL(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseWASM(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseSolidity(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseCMake(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];

	public static dynamic function parseDefault(text:String):Array<{color:Int, start:Int, end:Int}>
		return [];
}
